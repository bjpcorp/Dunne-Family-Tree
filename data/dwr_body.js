...
function BuildMenu()
{
	...
	txt_form1 += '<input id="dwr-search-' + nbSearchForms + '-txt" type="text" class="form-control dwr-search" placeholder="' + _('Search Name...') + '">';
...
function embedSearchText()
{
	...
	txt_form += '<input id="dwr-search-' + nbSearchForms + '-txt" type="text" class="form-control dwr-search" placeholder="' + _('Search Name...') + '">';
